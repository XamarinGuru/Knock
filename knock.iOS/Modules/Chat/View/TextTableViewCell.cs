...
{
	public class TextTableViewCell : BubbleTableViewCell
	{
		public TextTableViewCell (MessageCell cell) : base(cell)
		{
		}
		...
		protected override void UpdateConstraintsForIncomingCell(UIImageView bubbleImageView)
		{
			...
			this.ContentView.AddConstraints (new [] {
				NSLayoutConstraint.Create (this._label, NSLayoutAttribute.Top, NSLayoutRelation.Equal, bubbleImageView, NSLayoutAttribute.Top, 1, 18),
				NSLayoutConstraint.Create (this._label, NSLayoutAttribute.Bottom, NSLayoutRelation.Equal, bubbleImageView, NSLayoutAttribute.Bottom, 1, -20),
				NSLayoutConstraint.Create (this._label, NSLayoutAttribute.Leading, NSLayoutRelation.GreaterThanOrEqual, bubbleImageView, NSLayoutAttribute.Leading, 1, 16),
				NSLayoutConstraint.Create (this._label, NSLayoutAttribute.CenterX, NSLayoutRelation.Equal, bubbleImageView, NSLayoutAttribute.CenterX, 1, 3),
		...
		protected override void UpdateConstraintsForOutgoingCell(UIImageView bubbleImageView)
		{
			...
			this.ContentView.AddConstraints (new [] {
				NSLayoutConstraint.Create (this._label, NSLayoutAttribute.Top, NSLayoutRelation.Equal, bubbleImageView, NSLayoutAttribute.Top, 1, 18),
				NSLayoutConstraint.Create (this._label, NSLayoutAttribute.Bottom, NSLayoutRelation.Equal, bubbleImageView, NSLayoutAttribute.Bottom, 1, -20),
				NSLayoutConstraint.Create (this._label, NSLayoutAttribute.Trailing, NSLayoutRelation.LessThanOrEqual, bubbleImageView, NSLayoutAttribute.Trailing, 1, -16),
				NSLayoutConstraint.Create (this._label, NSLayoutAttribute.CenterX, NSLayoutRelation.Equal, bubbleImageView, NSLayoutAttribute.CenterX, 1, -3),
