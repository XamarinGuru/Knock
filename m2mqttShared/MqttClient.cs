...
namespace uPLibrary.Networking.M2Mqtt
{
    ...
    public class MqttClient
    {
		...
		public bool IsConnected { 
			...
			private set { isConnected = value; OnConnectedChanged(new EventArgs());}
		}
		...
		public bool IsConnecting
		{
			...
			private set { isConnecting = value; OnConnectingChanged(new EventArgs()); }
		}

		public event EventHandler ConnectedChanged;
		public void OnConnectedChanged(EventArgs e)
		{
		...
		public void OnConnectingChanged(EventArgs e)
		{
			EventHandler handler = ConnectingChanged;
			if (handler != null)
			{
				handler(null, e);
			}
...
*/
        ...
        public byte Connect(string clientId)
        {
			...
			try
			{
				res = this.Connect(clientId, null, null, false, MqttMsgConnect.QOS_LEVEL_AT_MOST_ONCE, false, null, null, true, MqttMsgConnect.KEEP_ALIVE_PERIOD_DEFAULT);
				IsConnecting = false;
			}
			catch (Exception ex)
			{
        ...
        {
			IsConnecting = true;
			var res =  this.Connect(clientId, username, password, false, MqttMsgConnect.QOS_LEVEL_AT_MOST_ONCE, false, null, null, true, MqttMsgConnect.KEEP_ALIVE_PERIOD_DEFAULT);
			IsConnecting = false;
			return res;
        }
        ...
        {
			IsConnecting = true;
            var res =  this.Connect(clientId, username, password, false, MqttMsgConnect.QOS_LEVEL_AT_MOST_ONCE, false, null, null, cleanSession, keepAlivePeriod);
			IsConnecting = false;
			return res;
        }
            ...
            ushort keepAlivePeriod)
        {
            ...
            catch (Exception ex)
            {
				...
				return MqttMsgConnack.CONN_REFUSED_NOT_AUTHORIZED;
            }
