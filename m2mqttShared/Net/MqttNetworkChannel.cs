...
*/
        ...
        /// </summary>
        public void Connect(int mSecTimeout)
        {
			/*OLD
			...
			*/
			...
			IAsyncResult result = socket.BeginConnect(this.remoteIpAddress, this.remotePort, null, null);
			bool success = result.AsyncWaitHandle.WaitOne(mSecTimeout, true);
			if (!success)
			{
				// NOTE, MUST CLOSE THE SOCKET
				socket.Close();
				throw new TimeoutException("Failed to connect server due to timeout.");
			}
//#if SSL
